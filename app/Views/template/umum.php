            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle <?= $title == 'Sejarah Desa' || $title == 'Visi Dan Misi Desa'  ? 'active' : ''; ?>" data-bs-toggle="dropdown">Profil Desa</a>
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle <?= $title == 'Data Desa' || $title == 'Data Penduduk' || $title == 'Data Status Perkawinan' || $title == 'Data Agama' || $title == 'Data Kelompok Usia' ? 'active' : ''; ?>" data-bs-toggle="dropdown">Statistk</a>
                        <div class="dropdown-menu m-0">
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-5 text-white animated zoomIn"><?= $title; ?></h1>
                </div>
            </div>
        </div>
    </div>
