        ...
        <div class="row gx-0">
            <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
                <div class="d-inline-flex align-items-center" style="height: 45px;">
                    <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>Jl. Ciharuman</small>
                    <small class="me-3 text-light"><i class="fa fa-phone-alt me-2"></i>+012 345 6789</small>
                    <small class="text-light"><i class="fa fa-envelope-open me-2"></i>harumansari@gmail.com</small>
                </div>
            </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-8">
                    <!-- Blog Detail Start -->
                    <div class="mb-5">
                        <img class="img-fluid w-100 rounded" src="<?= base_url("assetsAdmin"); ?>/img/<?= $berita['img']; ?>" alt="">
                        <div class="p-4">
                            <div class="d-flex mb-3">
                                <small class="me-3"><i class="far fa-user text-primary me-2"></i><?= $berita['penulis']; ?></small>
                                <small><i class="far fa-calendar-alt text-primary me-2"></i><?= $berita['tanggal']; ?></small>
                            </div>
                        </div>
                    ...
                    <div class="bg-light rounded p-5">
                        <div class="section-title section-title-sm position-relative pb-3 mb-4">
                            <h3 class="mb-0">Berikan Komentar</h3>
                        </div>
                        <form action="<?= base_url("Proses/prosesKomentar"); ?>" method="post" id="formKomentar">
                            <div class="row g-3">
                                <div class="col-12 col-sm-6">
                                    <input type="text" name="nama" id="nama" class="form-control bg-white border-0" placeholder="Masukan nama anda" style="height: 55px;">
                                    <div class="invalid-feedback invalid-nama"></div>
                                    <input type="hidden" name="id_berita" value="<?= $berita['id']; ?>">
                                </div>
                                <div class="col-12 col-sm-6">
                                    <input type="number" name="telepon" class="form-control bg-white border-0" placeholder="Masukan Telepon" style="height: 55px;">
                                </div>
                                <div class="col-12">
                                    <input type="text" name="alamat" class="form-control bg-white border-0" placeholder="Masukan Alamat" style="height: 55px;">
                                </div>
                                <div class="col-12">
                                    <textarea class="form-control bg-white border-0" name="komentar" rows="5" placeholder="Berikan Komentar"></textarea>
                                </div>
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3 btnSimpan" type="submit">Simpan</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        $(document).ready(function() {
            ...
            $("#formKomentar").submit(function(e) {
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    beforeSend: function() {
                        $(".btnSimpan").text('Sedang Menyimpan')
                    },
                    complete: function() {
                    ...
                    success: function(data) {
                        ...
                        if (data.error) {
                            if (data.error.nama) {
                                ...
                                $(".invalid-nama").text(data.error.nama)
                            }
                        }
                        if (data.sukses) {
                            Swal.fire(
