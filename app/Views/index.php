...
<body>
        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h6 class="display-5 text-white mb-md-4 animated zoomIn textWelcome">Selamat Datang di Website Resmi Desa <?= $dataDesa['nama_desa'] ? $dataDesa['nama_desa'] : 'nama desa'; ?></h6>
                            <a href="<?= $dataDesa['email'] ? 'mailto:' . $dataDesa['email'] : '#'; ?>" class="btn btn-primary btnGambar py-md-3 px-md-5 me-3 animated slideInLeft"><i class="fas fa-envelope"></i> Email</a>
                            <a href="" class="btn btn-outline-light py-md-3 px-md-5 btnGambar animated slideInRight"><i class="fab fa-whatsapp"></i> WhatsApp</a>
                        </div>
                    </div>
                </div>
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        <div class="p-3" style="max-width: 900px;">
                            <h6 class="display-5 text-white mb-md-4 animated zoomIn textWelcome">Hubungi Kami</h6>
                            <a href="quote.html" class="btn btn-primary py-md-3 px-md-5 me-3 btnGambar animated slideInLeft"><i class="fas fa-envelope"></i> Email</a>
                            <a href="" class="btn btn-outline-light py-md-3 px-md-5 btnGambar animated slideInRight"><i class="fab fa-whatsapp"></i> WhatsApp</a>
                        </div>
                    </div>
                </div>
    ...
    <div class="container-fluid facts pt-lg-0">
        <div class="container pt-lg-0 infoDataDesa">
            <div class="row gx-0 justify-content-center">
                <?php foreach ($dataDesa2 as $row) : ?>
                    <div class="col-lg-4 wow zoomIn cardInfoDesa" data-wow-delay="0.1s">
                        <div class="bg-primary bgCardInfo shadow d-flex align-items-center justify-content-around p-4" style="height: 150px;">
                            <div class="bg-white d-flex align-items-center justify-content-center rounded mb-2" style="width: 60px; height: 60px;">
                                <i class="fa fa-users text-primary"></i>
                            </div>
                            <div class="ps-4">
                                <h5 class="text-white mb-0 textCard"><?= $row['atribut']; ?></h5>
                                <h1 class="text-white mb-0 textCard" data-toggle="counter-up"><?= $row['jumlah']; ?></h1>
                            </div>
                        </div>
                    </div>
                <?php endforeach; ?>
    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" id="about">
        <div class="container py-5" id="lokasi">
            <div class="row g-5">
                <div class="col-lg-12">
    ...
    <!-- Team Start -->
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s" style="margin-top: 10%;">
        <div class="container py-5" id="aparatDesa">
                    ...
                    <div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
                        <div class="team-item bg-light rounded overflow-hidden">
                            <div class="team-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="<?= base_url("assets"); ?>/img/<?= $row['img']; ?>" alt="">
    ...
    <!-- Blog Start -->
    <!-- Blog Start -->
    <div class="container-fluid py-5 wow fadeInUp berita" data-wow-delay="0.1s">
        <div class="container py-5 berita">
            <div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
            ...
            <div class="row g-5">
                <div class="col-lg-8">
                    ...
                    <div class="mb-5">
                        <div class="row">
                            <?php if ($viewBerita['judul'] != '') : ?>
                                <div class="col-md-12 wow slideInUp" data-wow-delay="0.1s">
                                    <div class="blog-item bg-light rounded overflow-hidden">
                                        <div class="blog-img position-relative overflow-hidden">
                                            <img class="img-fluid" src="<?= base_url("assetsAdmin"); ?>/img/<?= $viewBerita['img']; ?>">
                            ...
                            <?php else : ?>
                                <h3 class="text-center">Belum Ada Berita Untuk Ditampilkan</h3>
                            <?php endif; ?>
                        </div>
                    </div>
                    <!-- Blog Detail End -->
    ...
    <script>
        ...
        if (window.screen.availWidth <= 400) {
            $('.bgCardInfo').removeClass('bg-primary p-4')
            $('.textCard').removeClass('text-white')
            $('.textCard').addClass('text-primary')
            $('.bgCardInfo').removeAttr('style')

            $("#about").removeClass('py-5')
            // $("#lokasi").removeClass('py-5')
            $("#aparatDesa").removeClass('py-5')
            $(".berita").removeClass('py-5')
        }
    </script>
</body>
